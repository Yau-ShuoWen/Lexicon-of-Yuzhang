...
public class TestFormat
{
    ...
    void test()
    {
        ...
        var s = UString.of("我是一个南昌人，南昌的拼音是[lan4][cong1]，普通话拼音是[+nan2][+chang1]，国际音标是[*lan4][*cong1]，键盘写作[/lan4][/cong1]");
        System.out.println("写法为：" + s);
        System.out.println("效果为：" + RichTextUtil.format(s, Dialect.NAM,
                new IPAData(Language.SC, Dialect.NAM, PinyinOption.defaultOf())));
    }
}
